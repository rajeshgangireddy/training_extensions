...
DATASET_TEST_CASES = [
    DatasetInfo(
        ...
        path=Path("anomaly/mvtec/mvtec_cable_tiny"),
        group="tiny",
        extra_overrides={},
    ),
    DatasetInfo(
        name="mvtec_capsule_tiny",
        path=Path("anomaly/mvtec/mvtec_capsule_tiny"),
        group="tiny",
        extra_overrides={},
    ),
    DatasetInfo(
        name="mvtec_hazelnut_small",
        path=Path("anomaly/mvtec/mvtec_hazelnut_small"),
        group="small",
        extra_overrides={},
    ),
    DatasetInfo(
        name="mvtec_transistor_small",
        path=Path("anomaly/mvtec/mvtec_transistor_small"),
        group="small",
        extra_overrides={},
    ),
    DatasetInfo(
    ...
    DatasetInfo(
        ...
        path=Path("anomaly/mvtec/visa_capsules_medium"),
        group="medium",
        extra_overrides={},
    ),
    DatasetInfo(
        name="visa_pcb3_large",
        path=Path("anomaly/mvtec/visa_pcb3_large"),
        group="large",
        extra_overrides={},
    ),
]
