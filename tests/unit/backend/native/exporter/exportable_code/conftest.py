...
def fxt_fix_exportable_code_import_error():
    ...
    # 'otx.backend.native.exporter.exportable_code.demo.demo_package' and it makes an error as below.
    ...
    # import 'otx.backend.native.exporter.exportable_code.demo.demo_package' and register it as 'demo_package'.
